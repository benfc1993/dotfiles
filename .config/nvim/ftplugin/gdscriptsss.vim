...
set nolisp         " Make sure lisp indenting doesn't supersede us
set autoindent     " indentexpr isn't much help otherwise

set indentexpr=GetGdscriptIndent(v:lnum)
set indentkeys+=<:>,=elif,=except
